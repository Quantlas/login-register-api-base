...
<body class="antialiased">
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <h1 style="text-align: center; font-size: 3em; font-weight: 900; margin-top: 2%;">Login Register API REST
                Base V1</h1>
            <h2 style="text-align: center;">power by <a href="https://github.com/hierro59" target="_blank">Hierro59</a>
            </h2>

            {{-- <div class="mt-16" style="font-weight: ">
